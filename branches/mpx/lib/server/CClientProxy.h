...
public:
	...
	*/
	...
	virtual void		getCursorPos(SInt32& x, SInt32& y, UInt8) const = 0;

	// IClient overrides
	virtual void		enter(SInt32 xAbs, SInt32 yAbs, UInt32 seqNum, KeyModifierMask mask,
							bool forScreensaver, UInt8, UInt8) = 0;
	virtual bool		leave(UInt8) = 0;
	...
	virtual void 		mouseMove(SInt32 xAbs, SInt32 yAbs, UInt8) = 0;
	virtual void 		mouseRelativeMove(SInt32 xRel, SInt32 yRel, UInt8) = 0;
	virtual void 		mouseWheel(SInt32 xDelta, SInt32 yDelta, UInt8) = 0;
