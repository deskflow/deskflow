...
public:
	...
	*/
	...
	virtual void		keyDown(KeyID, KeyModifierMask, KeyButton, UInt8 id) = 0;
	virtual void		keyRepeat(KeyID, KeyModifierMask,
							SInt32 count, KeyButton, UInt8 id) = 0;
	virtual void		keyUp(KeyID, KeyModifierMask, KeyButton, UInt8 id) = 0;
