...
<context>
    ...
    <message>
        ...
        <translation type="finished">Synergy et permet compartir fàcilment el ratolí i teclat entre diversos ordinadors en el seu escriptori, i és lliure i de codi obert. Només cal moure el punter del ratolí per la vora de la pantalla d'un ordinador a un altre. Fins i tot pots compartir el portapapers. Tot el que és necessita és una connexió de xarxa. Synergy és multiplataforma (funciona en Windows, Mac OS X i Linux).</translation>
    </message>
    <message>
