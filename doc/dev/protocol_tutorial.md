...
*Note: The code in this tutorial was compiled on a Windows machine, but not tested against a live server. Adapt as needed for your environment.*

## Scenario

Imagine a setup with three computers:
- The first is your primary desktop, running the Deskflow server.
- The second is another computer (e.g., a laptop) running the standard Deskflow client.
- The third computer runs a custom operating system.

Our goal is to build a new, minimal client from scratch for this custom OS, allowing it to be controlled seamlessly by the primary desktop.
...
// Protocol constants (@ref ProtocolTypes.h for full list)
...
// Protocol constants (@ref ProtocolTypes.h)
const char* kMsgHello = "Deskflow";
const char* kMsgHelloBack = "Deskflow";
const char* kMsgCEnter = "CINN";
const char* kMsgCLeave = "COUT";
...
*Full protocol documentation: @ref protocol_reference.md*