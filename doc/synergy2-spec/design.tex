...
% TODO: Decide to use server-model or P2P, or both (some users may not like 
% P2P).

% TODO: Finalize this section.

% TODO: Write based on discussion from
%   http://groups.google.com/group/synergy-plus-dev/browse_thread/thread/5a09353d55fc1364}

\subsection{Protocol}

% TODO: Support encryption from the start?

% TODO: Chris says to only support key codes, not both chars and codes!

% TODO: Talk about TCP multiplexing (for priority; where clipboard data 
