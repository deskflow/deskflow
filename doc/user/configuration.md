...
The configuration file is a plain text file and he configuration file is case-sensitive. The file is broken into sections and each section has the form:
