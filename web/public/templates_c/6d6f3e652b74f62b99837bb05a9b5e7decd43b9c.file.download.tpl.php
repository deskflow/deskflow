<?php /* Smarty version Smarty-3.1.8, created on 2012-03-13 02:59:21
         compiled from "download.tpl" */ ?>
<?php /*%%SmartyHeaderCode:232224f5ea7c58225c2-94435860%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d6f3e652b74f62b99837bb05a9b5e7decd43b9c' => 
    array (
      0 => 'download.tpl',
      1 => 1331606691,
      2 => 'file',
  ...
  'nocache_hash' => '232224f5ea7c58225c2-94435860',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_4f5ea7c5862d01_48813489',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_4f5ea7c5862d01_48813489')) {function content_4f5ea7c5862d01_48813489($_smarty_tpl) {?><?php if (!is_callable('smarty_block_t')) include 'C:\\Projects\\synergy\\web\\public\\smarty\\libs\\plugins\\block.t.php';
?>﻿<div class="download">
...
<b>Latest release:</b> 1.4.7 Beta (Feb 5, 2012)<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</p>
  ...
  <div class="donate">
    <div class="paypal">
      <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
        ...
        <input type="hidden" name="encrypted" value="-----BEGIN PKCS7----------END PKCS7-----">
        <input type="image" src="https://www.paypal.com/en_GB/i/btn/btn_donate_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online.">
        <img alt="" border="0" src="https://www.paypal.com/en_GB/i/scr/pixel.gif" width="1" height="1">
      </form>
    </div>
    <div class="flattr">
      <a class="FlattrButton" style="display:none;" rev="flattr;button:compact;" href="http://synergy-foss.org/"></a>
...
Please use version 1.4 for easier setup. Use version 1.3 if you experience problems.<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <div class="item">
      <h3><img src="/img/source-icon.png" /> <?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Source code<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h3>
      <p>
  ...
  <div class="alt">
    ...
    <h2><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Previous 1.4 releases<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h2>
    ...
    <h2><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Previous 1.3 releases<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h2>
    ...
    <p>
      ...
      <a href="http://synergy.googlecode.com/files/synergy-1.3.7-MacOSX106-Universal.zip">1.3.7 Mac OS X 10.6 Universal</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.7-MacOSX105-Universal.zip">1.3.7 Mac OS X 10.5 Universal</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.7-MacOSX104-Universal.zip">1.3.7 Mac OS X 10.4 Universal</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.7-Linux-i686.deb">1.3.7 Linux (deb) 32-bit</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.7-Linux-x86_64.deb">1.3.7 Linux (deb) 64-bit</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.7-Linux-i686.rpm">1.3.7 Linux (rpm) 32-bit</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.7-Linux-x86_64.rpm">1.3.7 Linux (rpm) 64-bit</a><br />
    ...
    <p>
      ...
      <a href="http://synergy.googlecode.com/files/synergy-1.3.6p2-MacOSX-Universal.zip">1.3.6 Mac OS X Universal</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.6-Linux-i686.deb">1.3.6 Linux (deb) 32-bit</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.6-Linux-x86_64.deb">1.3.6 Linux (deb) 64-bit</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.6-Linux-i686.rpm">1.3.6 Linux (rpm) 32-bit</a><br />
      <a href="http://synergy.googlecode.com/files/synergy-1.3.6-Linux-x86_64.rpm">1.3.6 Linux (rpm) 64-bit</a><br />
    ...
    <p>
      ...
      <a href="http://synergy.googlecode.com/files/synergy-1.3.1-Linux-i386.rpm">1.3.1 Linux (rpm) 32-bit</a><br /><a href="http://synergy.googlecode.com/files/synergy-1.3.1-MacOSX-i386.tar.gz">1.3.1 Mac OS X Intel 32-bit</a><br /><a href="http://synergy.googlecode.com/files/synergy-1.3.1-Source.tar.gz">1.3.1 Source code</a></p>

    <h2><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Other projects<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h2>
    <p><a href="/pm/projects/synergy/wiki/IOS_client" class="wiki-page">iOS client by Matthias Ringwald</a> (iPad/iPhone)</p>

    <h2><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Related sites<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</h2>
    <p>
      <a href="http://synergy-foss.org/nightly"><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Nightly builds<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</a> (<em><?php $_smarty_tpl->smarty->_tag_stack[] = array('t', array()); $_block_repeat=true; echo smarty_block_t(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
use at your own risk<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t(array(), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
</em>)<br />
