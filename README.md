...
Note: copy/paste from Wayland is [WIP](https://github.com/deskflow/deskflow/issues/8031) [(full list
of Wayland issues)](https://github.com/deskflow/deskflow/discussions/7499).
