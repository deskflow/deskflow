...
> [!IMPORTANT]
> 🚀 Deskflow is now the upstream project for Deskflow.
>
> The project has been renamed to draw a line between the community-run project (now Deskflow),
> and the commercially licensed product, Deskflow (a mix of open source and proprietary).
>
...
[Deskflow](https://symless.com/synergy) is a keyboard and mouse sharing app.
Use the keyboard, mouse, or trackpad of one computer to control nearby computers, 
and work seamlessly between them.

This project contains the source code for _Deskflow 1 Community Edition_ which is actively
maintained.
Deskflow 1 Community Edition is free and open source software, and anyone is welcome to build it,
...
![Deskflow 1 Community Edition](https://github.com/user-attachments/assets/faf5bd69-336c-4bd0-ace3-e911f199d961)
...
maintaining and improving Deskflow 1 Community Edition for years to come and we're excited to work
...
Deskflow 1 Community Edition is packaged by the community (status shown below).

Deskflow 2 is no longer in development and we recommend that package maintainers do not provide it.

Deskflow 3 and Deskflow 1 (licensed) are available to download from the
...
Deskflow is already available through most package managers as `synergy`, and we would love to see
the latest version of Deskflow 1 Community Edition on every package manager for every OS we support
(Windows, macOS, Linux, Unix-like BSD-derived, etc).

Package maintainers can use `scripts/package.py` to see how we build packages.
Feel free to contact us if you have any questions about packaging Deskflow.
...
### Has Deskflow moved beyond its goals from the 1.x era?

Our goal for Deskflow 1 (including the community edition) has always been and will always be to
make a simple, reliable, and feature-rich mouse and keyboard-sharing tool. We do maintain another
product called Deskflow 3, but as this uses Deskflow 1 Core (the server and client part of Deskflow),
we depend on Deskflow 1 to remain stable and modern which is why we continue to develop and improve
the product.
...
It's great that people spin up re-branded forks of Deskflow, power to them. However, it's not
necessary if you want to make changes.
If you're thinking of starting your own re-branded fork of Deskflow, it might be because we're
...
Wayland support for Deskflow. We would like to give special thanks to Peter Hutterer (@whot),
who is the author of `libei`, a major contributor to `libportal`, and the author of the Wayland
implementation in Deskflow. Others such as Olivier Fourdan helped with the Wayland implementation,
and we rely on the work of our community of developers to continue the development of Wayland 
support.

### Where did it all start?

Deskflow was first created in 2001 by Chris Schoeneman.
