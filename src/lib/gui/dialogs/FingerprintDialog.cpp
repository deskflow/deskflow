...
{
  m_localPreview = new FingerprintPreview(this, localFingerprint, "Local Fingerprint", false);
  m_remotePreview =
      new FingerprintPreview(this, remoteFingerprint, isServer ? "Client Fingerprint" : "Server Fingerprint", false);
...
void FingerprintDialog::togglePreviewMode(bool hashMode)
{
  ...
  updateHelpButton(hashMode);
}

void FingerprintDialog::updateHelpButton(bool hashMode) const
{
