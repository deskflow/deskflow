...
{
  m_textLog->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Expanding);
  m_textLog->setReadOnly(true);
  m_textLog->setMaximumBlockCount(10000);
  m_textLog->setLineWrapMode(QPlainTextEdit::NoWrap);
  m_textLog->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
  m_textLog->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
