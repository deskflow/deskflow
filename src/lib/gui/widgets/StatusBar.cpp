...
void StatusBar::setSecurityIcon(bool encrypted)
{
  const auto icon =
      ...
      QIcon::fromTheme(encrypted ? QIcon::ThemeIcon::SecurityHigh : QIcon::ThemeIcon::SecurityLow);
#else
      QIcon::fromTheme(encrypted ? QStringLiteral("security-high") : QStringLiteral("security-low"));
#endif
