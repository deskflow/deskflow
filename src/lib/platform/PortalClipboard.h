...
public:
  explicit PortalClipboard(
      PortalClipboardProxy *proxy, PortalClipboardProxy::SelectionType type = PortalClipboardProxy::Standard
  );
...
private Q_SLOTS:
  void
  onSelectionOwnerChanged(const QStringList &mimeTypes, bool sessionIsOwner, PortalClipboardProxy::SelectionType type);
