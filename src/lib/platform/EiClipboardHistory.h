...
struct ClipboardHistoryEntry
{
  ...
  ClipboardHistoryEntry(
      IClipboard::EFormat fmt, const std::string &d, const std::string &h, bool sensitive = false,
...
public:
  ...
  void addEntry(
      IClipboard::EFormat format, const std::string &data, const std::string &hash, bool containsSensitiveData = false,
