...
bool sleepInhibitCall(bool state, XWindowsPowerManager::InhibitScreenServices serviceID)
{
  ...
  if (!XWindowsPowerManager::DBusInhibitScreenCall(serviceID, state, error)) {
...
#ifndef __APPLE__
bool XWindowsPowerManager::DBusInhibitScreenCall(InhibitScreenServices serviceID, bool state, std::string &error)
{
  error = "";
