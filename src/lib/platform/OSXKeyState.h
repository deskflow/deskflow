...
public:
  ...
  */
  ...
  //! Send all keys generated by one macOS keyboard event
  /*!
  macOS can produce multiple characters for one physical key press.  Send
  intermediate characters as clicks so they do not look like auto-repeat
  events sharing \p button.  Genuine repeats remain repeat events.
  */
  void sendKeyEvents(
