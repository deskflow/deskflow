...
OSXKeyState::OSXKeyState(IEventQueue *events, synergy::KeyMap &keyMap) : KeyState(events, keyMap)
{
    init();
}
...
void OSXKeyState::getKeyMapForSpecialKeys(synergy::KeyMap &keyMap, SInt32 group) const
{
...
bool OSXKeyState::getKeyMap(synergy::KeyMap &keyMap,
...
void OSXKeyState::handleModifierKey(void *target,
...
void OSXKeyState::adjustAltGrModifier(const KeyIDs &ids,
