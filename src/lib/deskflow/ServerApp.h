...
#if SYSAPI_WIN32
  inline static const std::string CONFIG_NAME = std::string(".sgc").insert(0, kAppName);
#elif SYSAPI_UNIX
  inline static const std::string CONFIG_NAME = std::string(".conf").insert(0, kAppName);
#endif
};
