...
public:
  ...
  */
  static void collectButtons(
      const ModifierToKeys &modifiers, ButtonToKeyMap &keys);
...
private:
  ...
  const KeyItemList *getKeyItemList(const KeyGroupTable &keyGroupTable,
      SInt32 group, KeyModifierMask desiredMask) const;
