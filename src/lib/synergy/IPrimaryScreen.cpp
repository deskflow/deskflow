...
bool IPrimaryScreen::ButtonInfo::equal(const ButtonInfo *a,
                                       const ButtonInfo *b) {
...
IPrimaryScreen::MotionInfo *IPrimaryScreen::MotionInfo::alloc(SInt32 x,
                                                              SInt32 y) {
...
IPrimaryScreen::WheelInfo *IPrimaryScreen::WheelInfo::alloc(SInt32 xDelta,
                                                            SInt32 yDelta) {
