...
void ArgParser_Test::server_setAddress()
{
...
void ArgParser_Test::server_setConfigFile()
{
  deskflow::ServerArgs serverArgs;
  const int argc = 3;
...
void ArgParser_Test::server_unexpectedParam()
{
  deskflow::ServerArgs serverArgs;
  const int argc = 2;
...
void ArgParser_Test::client_yScroll()
{
...
void ArgParser_Test::client_setLangSync()
{
  deskflow::ClientArgs clientArgs;
...
void ArgParser_Test::client_setInvertScroll()
{
  deskflow::ClientArgs clientArgs;
  const int argc = 2;
...
void ArgParser_Test::client_commonArgs()
{
  deskflow::ClientArgs clientArgs;
  clientArgs.m_enableLangSync = false;
  const int argc = 5;
...
void ArgParser_Test::client_setAddress()
{
  deskflow::ClientArgs clientArgs;
  const int argc = 2;
...
void ArgParser_Test::client_badArgs()
{
  deskflow::ClientArgs clientArgs;
  const int argc = 1;
...
void ArgParser_Test::deprecatedArg_crypoPass_true()
{
  int i = 1;
  const int argc = 3;
...
void ArgParser_Test::deprecatedArg_crypoPass_false()
{
  int i = 1;
  const int argc = 3;
...
void ArgParser_Test::generic_logLevel()
{
  int i = 1;
  const int argc = 3;
...
void ArgParser_Test::generic_logFile()
{
  int i = 1;
  const int argc = 3;
...
void ArgParser_Test::generic_logFileWithSpace()
{
  int i = 1;
  const int argc = 3;
...
void ArgParser_Test::generic_foreground()
{
  int i = 1;
  const int argc = 2;
...
void ArgParser_Test::generic_daemon()
{
  int i = 1;
  const int argc = 2;
...
void ArgParser_Test::generic_name()
{
  int i = 1;
  const int argc = 3;
...
void ArgParser_Test::generic_noRestart()
{
  int i = 1;
  const int argc = 2;
...
void ArgParser_Test::generic_unknown()
{
  int i = 1;
  const int argc = 2;
...
void ArgParser_Test::generic_noHook()
{
  int i = 1;
  const int argc = 2;
...
void ArgParser_Test::generic_DND()
{
