...
#include "test_ClipboardChunks.h"

#include "deskflow/ProtocolTypes.h"

void ClipboardChunks_Test::startFormatData()
{
  ClipboardID id = 0;
  uint32_t sequence = 0;
...
void ClipboardChunks_Test::formatDataChunk()
{
  ClipboardID id = 0;
  uint32_t sequence = 1;
...
void ClipboardChunks_Test::endFormatData()
{
  ClipboardID id = 1;
  uint32_t sequence = 1;
...
QTEST_MAIN(ClipboardChunks_Test)
