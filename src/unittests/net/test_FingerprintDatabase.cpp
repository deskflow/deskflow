...
#include "test_FingerprintDatabase.h"
...
void FingerprintDatabase_Test::parseDBLine()
{
...
void FingerprintDatabase_Test::readFile()
{
...
void FingerprintDatabase_Test::writeFile()
{
...
void FingerprintDatabase_Test::clear()
{
  FingerprintDatabase db;
  db.addTrusted({"algo1", {1, 2, 3, 4, 0xab}});
  db.clear();
...
void FingerprintDatabase_Test::trusted()
{
  FingerprintDatabase db;
  db.addTrusted({"algo1", {1, 2, 3, 4, 0xab}});
...
QTEST_MAIN(FingerprintDatabase_Test)
