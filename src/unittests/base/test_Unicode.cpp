...
void Unicode_Test::initTestCase()
{
  m_arch.init();
  m_log.setFilter(kDEBUG2);
}

void Unicode_Test::UTF32ToUTF8()
{
  bool errors;
...
void Unicode_Test::UCS2ToUTF8_kUCS2()
{
  bool errors;
