...
void MainWindow::connectSlots()
{
  ...
  connect(&m_appConfig, &AppConfig::invertConnectionChanged, this, &MainWindow::appConfigInvertConnectionChanged);
...
void MainWindow::appConfigInvertConnectionChanged()
{
  applyConfig();
}
