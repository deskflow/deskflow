...
protected:
    ...
    void
    readSettings (QSettings& settings, T1& array, const QString& arrayName,
                  const T2& deflt) {
    ...
    template <typename T>
    void
    writeSettings (QSettings& settings, const T& array,
