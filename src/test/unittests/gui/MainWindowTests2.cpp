...
class MainWindowTests2 : public QtTests {
public:
...
TEST_F(MainWindowTests2, checkSecureSocket_noMatch_expectFalse) {
...
TEST_F(MainWindowTests2, checkSecureSocket_match_expectTrue) {
  TestMainWindow testMainWindow;
