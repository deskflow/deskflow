...
TEST(SerialKeyTests, test_getMillisecondsLeft)
{
    SerialKey key;
    std::chrono::milliseconds expected{-1};
    EXPECT_EQ(expected, key.getMillisecondsLeft());
}

TEST(SerialKeyTests, test_getMillisecondsLeft_subscription)
{
    // {v2;subscription;basic;Bob;1;email;company name;0;86400}
    ...
    EXPECT_EQ(expected, key.getMillisecondsLeft(86399));
}
